...
- 7b99891: Bump @playwright/test from 1.62.0 to 1.63.0
...
- b42bacf: Bump vitest from 4.1.11 to 5.0.0
- 6b844df: Bump @vitest/coverage-v8 from 4.1.11 to 5.0.0
- ede2836: build(deps-dev): bump @types/node from 26.4.0 to 26.5.0
...
- 140a964: Pin transitive js-yaml to 4.3.2 to fix a high-severity npm audit finding (GHSA-2883-xcg3-v3hh)
...
- 0046bb2: Revert the compound-event async control port chevron rendering introduced in #438.
