...
Then(
  ...
  async function (this: BddWorld, name: string) {
    ...
    expect(
      ...
      // bit more than an uncut block, compacting the group's shape around the
      // anchored centroid and shifting each member a little further still.
      // Widen the (already approximate) tolerance to cover that.
