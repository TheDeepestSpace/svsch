...
export function ComparatorNodeSvg({ node, width, height, arrayConnections }: NodeSvgProps): React.ReactElement {
  ...
  return (
    <>
      ...
      <path
        className={`svsch-node-shape hdl-node-comparator node-skin-body${isArray ? ' hdl-node-array-layer hdl-node-array-front svsch-array-layer-front' : ''}`}
