declare module '@xyflow/react' {
  ...
  export const ReactFlow: <_NodeType extends Node = Node, _EdgeType extends Edge = Edge>(
    props: any,
  ) => React.ReactElement;
  ...
  export function useEdgesState<T extends Edge = Edge>(
    initialEdges: T[],
  ): [T[], (edges: T[] | ((eds: T[]) => T[])) => void, any];
  export function useNodesState<T extends Node = Node>(
    initialNodes: T[],
  ): [T[], (nodes: T[] | ((nds: T[]) => T[])) => void, any];
