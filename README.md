...
The first implementation treats HDL as read-only, renders a diagram in a webview editor panel, and persists only layout state, one file per module under `.svsch/layouts/`.
